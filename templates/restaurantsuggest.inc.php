 <div class="container">
   ...
   <form class="form-horizontal">
    ...
    <div class="form-group">
      <label for="email" class="col-sm-2 control-label">Restaurant Address</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <label for="restaurantName" class="col-sm-2 control-label">Phone</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <label for="restaurantAddress" class="col-sm-2 control-label">Your Email Address</label>
      <div class="col-sm-4">
